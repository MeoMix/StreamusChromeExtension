define([
    ...
    'dataSource',
    'utility'
], function (CreatePlaylistTemplate, StreamItems, Folders, YouTubeV2API, YouTubeV3API, DataSource, Utility) {
    'use strict';
                ...
                if (youTubeSource !== '') {
                    ...
                    switch (dataSource.type) {
                        ...
                        case DataSource.YOUTUBE_AUTOGENERATED:
                            ...
                            YouTubeV3API.getAutoGeneratedPlaylistTitle(dataSource.id, function (autoGeneratedPlaylistTitle) {

...
define([
    ...
    var Folder = Backbone.Model.extend({
        ...
        addPlaylistByDataSource: function (playlistTitle, dataSource) {
            ...
            var needsLoading = dataSource && (dataSource.type === DataSource.YOUTUBE_CHANNEL || dataSource.type === DataSource.YOUTUBE_PLAYLIST || dataSource.type === DataSource.YOUTUBE_FAVORITES || dataSource.type === DataSource.YOUTUBE_AUTOGENERATED);
            console.log("NeedsLoading:", needsLoading, dataSource);
            var playlist = new Playlist({
                title: playlistTitle,
                folderId: this.get('id'),

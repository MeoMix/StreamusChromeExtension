...
define([
    ...
    return {
        ...
        getAutoGeneratedPlaylistData: function() {
            console.log("getAutoGeneratedPlaylistData");
            //  The API Key is set through here: https://code.google.com/apis/console/b/0/?noredirect#project:346456917689:access 
            //  It can expire from time to time.
            gapi.client.setApiKey('AIzaSyBP0QWU5RrVhOP3GMZyix4ch4tTJyRB7mI');
            gapi.client.load('youtube', 'v3', function () {
                console.log("getapi.client.load youtube success");
                ...
                playlistItemsListRequest.execute(function (playlistItemsListResponse) {
                    console.log("playlistItemsListResponse:", playlistItemsListResponse);

define([
    ...
    'googleApiClient'
], function (Settings, Utility, DataSource) {
    'use strict';
    ...
    var YouTubeV3API = Backbone.Model.extend({
        ...
        getDataSourceResults: function (dataSource, callback) {
            ...
            if (!DataSource.isV3(dataSource.type)) throw "YouTubeV3 API getDataSourceResults expects a V3 dataSource";
            ...
            if (dataSource.type === DataSource.YOUTUBE_AUTOGENERATED) {
                ...
                //this.getAutoGeneratedPlaylistData(dataSource.id, callback);

    ...
    describe('DataSource', function () {
        ...
        it('Should be able to parse YouTube Playlist URLs', function() {
            ...
            expectDataSource(dataSource, {
                ...
                type: DataSourceType.YOUTUBE_PLAYLIST,
        ...
        it('Should be able to parse YouTube Favorites URLs', function() {
            ...
            expectDataSource(dataSource, {
                ...
                type: DataSourceType.YOUTUBE_FAVORITES,
        ...
        it('Should be able to parse YouTube Channel URLs', function() {
            ...
            expectDataSource(dataSource, {
                ...
                type: DataSourceType.YOUTUBE_CHANNEL,
        ...
        it('Should be able to parse YouTube Auto-Generated Playlist URLs', function() {
            ...
            expectDataSource(dataSource, {
                ...
                type: DataSourceType.YOUTUBE_AUTOGENERATED
            });
        ...
        xit('Should be able to parse Streamus Shared Playlist URLs', function () {
            ...
            //expectDataSource(dataSource, {
            //    sourceId: '',
            //    type: DataSourceType.SHARED_PLAYLIST
            //});

        });

        it('Should have a properly working success callback for getTitle', function() {
            ...
            }, 2000, 'DataSource should have called success');
        });
        ...
        it('Should have a properly working error callback for getTitle', function() {
            ...
            waitsFor(function () {
                return errorCalled;
            }, 2000, 'DataSource should have called error');
        });
        ...
        it('Should be able to get a youtube playlist title', function() {
            ...
            }, 500, 'DataSource should have retrieved its title');
        ...
        it('Should be able to successfully indicate whether it is a V3 YouTube API source', function() {
            ...
            dataSource = new DataSource({ type: DataSourceType.YOUTUBE_AUTOGENERATED });
            expect(dataSource.isV3()).toEqual(true);
            
            dataSource = new DataSource({ type: DataSourceType.YOUTUBE_CHANNEL });
        ...
        it('Should be able to successfully indicate whether it needsLoading', function () {
            ...
            dataSource = new DataSource({ type: DataSourceType.YOUTUBE_PLAYLIST });
            expect(dataSource.needsLoading()).toEqual(true);
            
            dataSource = new DataSource({ type: DataSourceType.YOUTUBE_FAVORITES });
            expect(dataSource.needsLoading()).toEqual(true);
            ...
            dataSource = new DataSource({ type: DataSourceType.SHARED_PLAYLIST });
            expect(dataSource.needsLoading()).toEqual(false);
            
            dataSource = new DataSource({ type: DataSourceType.USER_INPUT });
            expect(dataSource.needsLoading()).toEqual(false);
        });

...
import ChromeNotificationsManager from 'background/model/chromeNotificationsManager';
import ChromeOmniboxManager from 'background/model/chromeOmniboxManager';
...
import TabManager from 'background/model/tabManager';
...
var BackgroundArea = Model.extend({
  defaults: function() {
    return {

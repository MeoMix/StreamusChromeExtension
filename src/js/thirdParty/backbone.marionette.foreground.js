...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['backbone.foreground', 'underscore'], function (Backbone, _) {
            return (root.MarionetteForeground = root.MnF = factory(root, Backbone, _));
        });
    } else if (typeof exports !== 'undefined') {
        var Backbone = require('backbone.foreground');
        var _ = require('underscore');
        module.exports = factory(root, Backbone, _);
    } else {
        root.MarionetteForeground = root.MnF = factory(root, root.Backbone, root._);
    }
    ...
    var previousMarionette = root.MarionetteForeground;

    var Marionette = Backbone.MarionetteForeground = {};

    Marionette.VERSION = '2.3.2';

    Marionette.noConflict = function () {
        root.MarionetteForeground = previousMarionette;
        return this;
    };

    Backbone.MarionetteForeground = Marionette;
    ...
    Marionette.isNodeAttached = function(el) {
        console.log('Backbone.$:', Backbone.$, Backbone.$.hello);

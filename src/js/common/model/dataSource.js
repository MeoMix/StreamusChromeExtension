        ...
        setUrl: function () {
            ...
            switch (this.get('type')) {
                case DataSourceType.YouTubeChannel:
                    url += 'users/' + this.get('id') + '/uploads';
                    break;
                case DataSourceType.YouTubeFavorites:
                    url += 'users/' + this.get('id') + '/favorites';
                    break;
                case DataSourceType.YouTubePlaylist:
                    url += 'playlists/' + this.get('id');
                    break;
                default:
        ...
        getTitle: function (options) {
            ...
            switch (this.get('type')) {
                ...
                case DataSourceType.YouTubeAutoGenerated:
                    ...
                    //YouTubeV3API.getAutoGeneratedPlaylistTitle(this.get('id'), function (autoGeneratedPlaylistTitle) {

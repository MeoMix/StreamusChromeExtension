    ...
    var DataSource = Backbone.Model.extend({
        ...
        initialize: function (options) {
            ...
            if (options && options.urlToParse) {
                ...
                this.set('songId', parsedDataSourceInformation.dataSourceId);
        ...
        setUrl: function () {
            ...
            switch (this.get('type')) {
                case DataSourceType.YouTubeChannel:
                    url += 'users/' + this.get('songId') + '/uploads';
                    break;
                case DataSourceType.YouTubeFavorites:
                    url += 'users/' + this.get('songId') + '/favorites';
                    break;
                case DataSourceType.YouTubePlaylist:
                    url += 'playlists/' + this.get('songId');
                    break;
                default:
        ...
        parseUrlForDataSourceInformation: function (urlToParse) {
            ...
            if (this.get('parseVideo')) {
                //  Start by trying to parse by songId because it should take priority over a playlist ID.
        ...
        getTitle: function (options) {
            ...
            switch (this.get('type')) {
                ...
                case DataSourceType.YouTubeAutoGenerated:
                    ...
                    //YouTubeV3API.getAutoGeneratedPlaylistTitle(this.get('songId'), function (autoGeneratedPlaylistTitle) {

define(function(require) {
  ...
  require('test/foreground/view/dialog/errorView.spec');
  ...
  require('test/foreground/view/dialog/googleSignInView.spec');
  require('test/foreground/view/dialog/linkUserIdDialogView.spec');
  require('test/foreground/view/dialog/linkUserIdView.spec');
